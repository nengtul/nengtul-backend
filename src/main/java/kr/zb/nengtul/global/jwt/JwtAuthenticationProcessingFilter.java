...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
   ...
   * UsernamePasswordAuthenticationToken의 파라미터 1. 위에서 만든 UserDetailsUser 객체 (유저 정보) 2. credential(보통
   * 비밀번호로, 인증 시에는 보통 null로 제거) 3. Collection < ? extends GrantedAuthority>로, UserDetails의 User 객체
   * 안에 Set<GrantedAuthority> authorities이 있어서 getter로 호출한 후에, new NullAuthoritiesMapper()로
